<?php
/*
Plugin Name: Srizon Responsive Youtube Album Pro
Plugin URI: http://www.srizon.com/srizon-responsive-youtube-album
Description: Show your Youtube Channel or Playlist on your WordPress Site
Version: 1.3
Author: Afzal
...
$SrzYTUpdateChecker = PucFactory::buildUpdateChecker(
	'http://www.srizon.com/upd/srz-yt-update.json',
	__FILE__,
...
function srz_yt_albums_edit() {
	if ( isset( $_GET['id'] ) ) {
		...
		$value_arr = array(
			...
			'respslidestart'   => '0',
			'targetheight'     => '200',
			'api_key'          => 'AIzaSyD9pXu6gtJuYbQRotG0yIu0gyidkCGh3jM'
		);
	}
	SrizonYTUI::OptionWrapperStart();
